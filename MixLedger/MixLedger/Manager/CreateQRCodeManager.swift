...
class CreateQRCodeManager {
    static let shared = CreateQRCodeManager()

    static func createQRCodeForString(_ text: String, size: CGSize) -> CIImage? {
        // 將文字資料轉換成Data
