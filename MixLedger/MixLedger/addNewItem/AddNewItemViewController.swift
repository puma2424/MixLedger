    ...
    */
    ...
    @objc func checkButtonActive(){
        if amount == nil {
            ...
            firebase.postData(toAccountID: currentAccountID, amount: -(amount ?? 0) , date: selectDate ?? Date(), note: "草莓", type: type, memberPayMoney: memberPayMoney, memberShareMoney: memberShareMoney){ result in
